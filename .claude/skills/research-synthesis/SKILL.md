...
# Research synthesis (the *onderzoek* layer)
...
## Conventions
1. **Citation-heavy.** Every non-trivial claim cites a source, kept *with* the claim — not only in
...
4. **Central caveat, preserved everywhere:** no study has shown any training activity *causes* a
