...
### P5 weekly-focus policy (`research-1.1.0`)

Weekly focus uses confidence-qualified behavioral weakness signals, accumulated SkillState,
due learning, and structural goal kinds to choose at most two ordered process focuses. A rating
goal maps to tactics and calculation process work. Its free-text label is never interpreted as a
diagnosis or daily objective. Alternatives are limited to remaining configured skill dimensions
and explicitly disclose the tradeoff against the evidence-led default.
