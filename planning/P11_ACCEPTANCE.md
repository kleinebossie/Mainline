...
| Meaningful changes affect the plan            | High     | Local, CI, and 14-day owner | Partial       | A time-budget change plus explicit replan replaced the active plan and persisted graded revision evidence.                        | Confirm naturally during the 14-day owner validation.                                                                |
| Isolated noise does not affect the plan       | High     | Local, CI, and 14-day owner | Partial       | Contextual feedback persisted without changing outcomes, adaptation logs, skill snapshots, or prior plan evidence.                | Confirm naturally during the 14-day owner validation.                                                                |
...
| Persisted focus and forecast explanations     | Critical | Local, CI, and 14-day owner | Partial       | Non-empty graded focus, forecast, and revision snapshots remained byte-equivalent after later actions.                            | Inspect explanations under natural changes during the 14-day validation.                                             |
...
| 14-day Stage A natural-use validation         | Critical | 14-day owner                | Owner         | Synthetic automation cannot replace natural use.                                                                                  | Complete 8 sessions, import 10 played games, include 1 manual or OTB game, and record adaptation/noise observations. |
| Invitation and rollback procedure             | High     | Owner and documentation     | Missing       | P11 still requires the owner-approved procedure before inviting pilot users.                                                      | Reconcile release docs and approve invitation and rollback after live and 14-day gates.                              |
