...
This document is a high-density, token-efficient cheat sheet designed to immediately orient any developer AI agent working in this repository.
...
- **Core Concept**: It decides *what to train, when, and why*, rather than being just another puzzle trainer.
...
- **More Context**: See [VISION.md](file:///home/joebos/programming/Mainline/planning/VISION.md) (intent), [BUILD.md](file:///home/joebos/programming/Mainline/planning/BUILD.md) (technical plan), and [CLAUDE.md](file:///home/joebos/programming/Mainline/CLAUDE.md) (developer guide).
